...
st.markdown('---')
st.markdown('This web application is built to analyze motor vehicle collisions in NYC using the [New York City Vehicle Collision](%s) data set from 4th July,2023.' % dataset_link)
